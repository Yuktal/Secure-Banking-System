...
<body>
	...
	<div id="container" class="container">
		<form action="${pageContext.request.contextPath}/tier2/updateOrDeleteExternalUser" method="post">
			...
			<div class="line submit">
				<input type="submit" name="operation" value="delete" class="btn btn-primary" />
			</div>
