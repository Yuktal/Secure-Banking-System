...
<meta name="_csrf_header" content="${_csrf.headerName}"/>
    ...
    <script>
   	 function checkAvailabilityUsername() {
   			...
   			console.log('this point is hitting');
			$.ajax({
				type:"POST",
				url:"${pageContext.request.contextPath}/tier2/checkinternalusername",
        ...
        <div id="container" class="container">
            <form action="${pageContext.request.contextPath}/tier2/modifyExternalUser" method="post" onsubmit="return validate()">
                <h1>${pagename} </h1>
                 <div class="line">
                 <label for="username">username *: </label>
                 <input type="text" id="username"  name="username" onblur="checkAvailabilityUsername()" required /> 
                 </div>
