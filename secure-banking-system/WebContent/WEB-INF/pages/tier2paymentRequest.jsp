		...
		<div class="container">
			...
			<div class="tab-content">
				<div id="creditdebit" class="tab-pane fade in active">
					...
					<div class="container">
						<form class="form-horizontal" method="post"
							action="${pageContext.request.contextPath}/tier2/requestForUser"
				...
				<div id="transfer" class="tab-pane fade">
					...
					<div class="container">
						<form class="form-horizontal" method="post"
							action="${pageContext.request.contextPath}/tier2/transferForUser"
				...
				<div id="payment" class="tab-pane fade">
					...
					<div class="container">
						<form class="form-horizontal" method="post"
							action="${pageContext.request.contextPath}/tier2/paymentForUser">
							<input type="hidden" name="forUser"
								value="${customerUser}" />
							<div class="form-group" style="padding-top: 40px">
								<label class="control-label col-sm-2" for="amount">Amount($):</label>
